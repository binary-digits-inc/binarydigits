...
export default function ContactForm() {
  ...
  return (
    <div className=" w-full   md:items-center md:justify-center bg-cyan-950 antialiased bg-grid-white/[0.02] relative overflow-hidden ">
      <Navbar
          ...
          <div
            className="
              ...
              text-gray-300
                    "
          >
            Let&apos;s talk about how we can take you and your business to the next level.
          </div>
            ...
            >
                  ...
                  <FormItem className="items-center justify-center w-full">
                    ...
                    >
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="Social Media Marketing">Web Design and Development</SelectItem>
                        <SelectItem value="51-200">App Development</SelectItem>
                        <SelectItem value="501-1000">Social Media Marketing</SelectItem>
                        <SelectItem value="1000+">E-Commerce Stores</SelectItem>
                        <SelectItem value="1000+">AI Optimization</SelectItem>
                      </SelectContent>
                    </Select>
                  </FormItem>
                )}
                      ...
                      <SelectContent>
                        <div className="flex gap-4">
                          <SelectItem value="Evaluate Bird for my company">
                            Evaluate binarydigits for my company
                          </SelectItem>
                        </div>
              ...
              <div className="flex gap-4 items-center">
                ...
                <div className="text-xs font-light  md:w-3/4 mb-1 bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to-neutral-400">
                  I agree to binarydigits&apos; sending marketing communications related
                  to technology, products, and services. I can unsubscribe at any time.
                </div>
              </div>
